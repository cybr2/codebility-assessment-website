...
import { disclaimerPolicy } from '../../data/disclaimerPolicy';
    ...
    return (
        <MainLayout>
            <div className="max-w-4xl mx-auto p-8">
                <h2 className="text-4xl font-bold mb-6">{disclaimerPolicy.title}</h2>
                <p className="text-gray-600 text-sm  mb-12">Last Updated: {disclaimerPolicy.updated}</p>
                <p className="text-gray-700 mb-6" dangerouslySetInnerHTML={{ __html: disclaimerPolicy.notice }} />

                {disclaimerPolicy.sections.map((section: ITermsSection, index: number) => (
                ...
                <p className="text-gray-700 mt-12">{disclaimerPolicy.description}</p>
            </div>
        </MainLayout>
    );
};
